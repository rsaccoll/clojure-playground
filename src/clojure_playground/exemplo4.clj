(ns clojure-playground.exemplo4)
...
(println "Reduce soma" (reduce minha-soma 0 precos))
(println "Reduce" (reduce minha-soma (range 15)))

(println "Reduce" (reduce minha-soma 0 []))

;(def vazio [])
;(println "Reduce" (reduce minha-soma vazio))
